...
class AddRestaurant(Toplevel):
    def __init__(self):
        Toplevel.__init__(self)
        self.geometry("650x750+550+200")
        self.title("New Restaurant")
    ...
    def SaveRestaurantInfo(self):
        ...
        try:
            updateRec = db.InsertIntoRestaurant(restaurant_Name, restaurant_Cuisine, restaurant_Zone, restaurant_Category, restaurant_Store, restaurant_Manager, restaurant_ManagerYears, restaurant_Email, restaurant_Address)
